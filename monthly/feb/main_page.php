	...
	<div class="container" >
		<div class="head" >
			...
			<a href="../../../search.php" title="Search" > <img src="../../../style/search1.png" class="left1" width="29px" style="margin-top:11px;margin-right: 25px;" ></a>
				...
				<div class="drop" >
					<a href="../../../monthly/feb/score/performance.php" title="Score OverView" class="drop"> <img src="../../../style/all.png" class="left1" width="25px" style="margin-top:11px;" ></a>
			...
			?>
					...
					<div class="triangle">
						<div class="drop_content" style="margin-top: 55px">
							<a href="../../../monthly/feb/score/performance.php" title="Score OverView" ><img src="../../../style/aa.png" style="width: 25px; "> <span class="drop_span">Score</span> </a>
						</div>	
		...
		<a href="../../feb/score_redirect_page.php"><div class="monthly active" style="position: fixed;height: 40px;width: 100px;background-color: #09a55c ; top: 130px; text-align: center;">
