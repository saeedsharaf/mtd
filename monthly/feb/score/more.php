...
<div class="s" style="width:80%; margin: 0 auto;  height:90% ; display: flex; margin-top: 10px;flex-wrap: wrap; margin-left: 175px;">
...
<div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px; margin-right: 50px; position: relative; ">
	...
	<!---------------------------------------------------------------------------------------------------->
		<div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px; margin-right: 50px; position: relative; margin: 0 auto;margin-left: 421px ">
			<div style="height: 10% ; background-color: #dd4d33; width: 100%">
