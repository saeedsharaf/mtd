...
<body>
	...
	?>
                ...
                <div id="alret">
                <div style="margin-top:17px" >Updated Till 10/20/2018 </div>
            </div>
            <div id="alret_nps">
                <div style="margin-top:17px" >Nps Updated Till 10/19/2018</div>
            </div>
	...
	<div class="container" >
		<div class="head" >
			...
			<a href="../../../search.php" title="Search" > <img src="../../../style/search1.png" class="left1" width="29px" style="margin-top:11px;margin-right: 25px;" ></a>
				...
				<div class="drop" >
					<a href="performance.php" title="Score OverView" class="drop"> <img src="../../../style/all.png" class="left1" width="25px" style="margin-top:11px;" ></a>
			...
			?>
					...
					<div class="triangle">
						<div class="drop_content" style="margin-top: 55px">
							<a href="performance.php" title="Score OverView" ><img src="../../../style/aa.png" style="width: 25px; "> <span class="drop_span">Score</span> </a>
						</div>	
				...
				<div class="triangle">
						<div class="drop_content" style="margin-top: 55px">
							<a href="achiever.php" title="Achiever OverView" ><img src="../../../style/aa.png" style="width: 25px; "> <span class="drop_span">Achiever</span> </a>
						</div>
	...
	<a href="../../jan/score_redirect_page.php"><div class="monthly" style="position: fixed;height: 40px;width: 100px;background-color: #01c5ed ; top: 90px; text-align: center;">
		...
		<a href="../../july/score_redirect_page.php"><div class="monthly " style="position: fixed;height: 40px;width: 100px;background-color: #0d00ff87 ; top: 330px; text-align: center;">
		...
		<a href="../../oct/score_redirect_page.php"><div class="monthly active" style="position: fixed;height: 40px;width: 100px;background-color: #005dffdb ; top: 450px; text-align: center;">
			<span class="month" style="">October </span>
