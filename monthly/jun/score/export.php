...
<?php
if($_GET['acw_not']){
	$sql="select * from jun where acw > 5 ";
}else if($_GET['acw']){
	$sql="select * from jun where acw > 5 ";
}else if($_GET['adh_not']){
	$sql="select * from jun where adherance < 95 ";
} else if($_GET['adh']){
	$sql="select * from jun where adherance >= 95 ";
	...
	$sql="select * from jun where attiude < 1 ";
}else if($_GET['attiude']){
	$sql="select * from jun where attiude > 0 ";
}else if($_GET['compl_not']){
	$sql="select * from jun where compliance > 0 ";
}else if($_GET['compl_not']){
	$sql="select * from jun where compliance < 1 ";
}else if($_GET['ctb_not']){
	$sql="select * from jun where ctb > 0 ";
}else if($_GET['ctb']){
	$sql="select * from jun where ctb < 1 ";
}else if($_GET['ctc_not']){
	$sql="select * from jun where ctc > 0 ";

}else if($_GET['ctc']){
	$sql="select * from jun where ctc < 1 ";
	...
	$sql="select * from jun where nc > 0 ";

}else if($_GET['nc']){
	$sql="select * from jun where nc < 1 ";
}else if($_GET['nps_not']){
	$sql="select * from jun where nps < 45 ";
} else if($_GET['nps']){
	$sql="select * from jun where nps > 45 ";
}else if($_GET['outbound_not']){
	$sql="select * from jun where outbound > 300 ";
	...
	$sql="select * from jun where manger_id >= 111 and manger_id < 444 ORDER BY final_score DESC ";
}


else{
	$sql="select * from jun order by final_score desc ";
}
