...
if($id == 2){
				?>
					<form action="export.php" method="get">
						<input type="submit" accesskey="s" name="nps_not"  style="display:none;">
					</form>
			<?php
...
if($aht > 260 ){
	...
	<div style="height:45px; width: 120px; color : <?php echo $nps_color; ?>" class="saeed brownch">
		<h1><?php echo $nps; ?> %</h1>
	</div>
	...
	<div style="height:45px; width: 120px;" class="saeed qch ">
		<h1><?php echo $final_score; ?> %</h1>
						...
						?>
							<form action="export.php" method="get">
								<input type="submit" accesskey="s" name="nps"  style="display:none;">
							</form>
						<?php
