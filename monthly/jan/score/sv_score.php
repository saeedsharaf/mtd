...
-->
<div style="height : 100px; width:100%;margin-top: 50px; text-align: center;" >
...
if($result->num_rows > 0){
	...
	$sql="select * from score where login_id = '$idd'";
$result=$cont->query($sql);
...
<div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px; margin-right: 50px; position: relative; ">
	...
	?>
		...
		<div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px;margin:0 auto;  position: relative;margin-left: -76; ">
				<div style="height: 10% ; background-color: #dd4d33; width: 100%">
...
-->
<div style="height : 200px; width:100%;margin-top: 100px; text-align: center;" >
	<span style="font-size: 30px"> TBD </span>
	</div>
<?php
