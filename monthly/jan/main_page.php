...
<body  >
	...
	<div class="container" >
		...
		<div id="mySidenav" class="sidenave" onmouseover="mouseOver()" onmouseout="mouseOut()" > 
			...
			<a href="../../jan/score_redirect_page.php"><div class="monthly active" style="position: fixed;height: 40px;width: 100px;background-color: #01c5ed ; top: 90px; text-align: center;">
