...
<div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px; margin-right: 50px; position: relative; ">
	...
	<!---------------------------------------------------------------------------------------------------->
		<a href="sv_score_more.php" style="height: 83px; margin: 0 auto; " title="More details"><div clas="aht" style="background-color: #1b1b1b38; height:80px; width:160px; margin-right: 50px; position: relative; ">
			<div style="height: 10% ; background-color: #dd4d33; width: 100%">
...
include'../monthly/jun/main_page.php';
