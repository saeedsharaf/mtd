...
<body>
	...
	<div class="container">
		<div class="head">
			...
			<map name="setting" >
			<area shape="circle"  coords="1259,76,1280,95"  href="../config/password.php">
			</map>
			</div>
			<!--
			<div class="page">
		...
		<div class="leftside">
			<div class="sss">
				...
				<a href="performance.php" class="performance" id="active"> Performance <span style="float:right;"> &#x0003E; </span> </a>
				<a href="nps.php" class="nps"> Nps <span style="float:right;"> &#x0003E; </span> </a>
			</div>
		...
		<div class="reset">
			...
			<span style="margin: 0 auto;" > Coming Soon </span>
		<!--
			<table class="tf">
