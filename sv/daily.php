...
<body>
	...
	<div class="container">
		<div class="head">
			...
			<div class="page">
			<div class="f" id="active"><ul style="list-style-type:none"><li><a href="daily.php"> Daily Dashboard </a></li></div>
			<div class="f" id=""><ul style="list-style-type:none"><li><a href="monthly.php"> Monthly Dashboard </a></li> </ul></div>
			</div>
		...
		<table style="margin-top: 20px;width:1000px; " class="ts">
