...
$sql = "select * from nps where manger_id != '555' and manger_id != '' ";
	
			$result = $cont->query($sql);
			$totalsurvey =  $result->num_rows ;
	
			$promoter = "select * from nps where nps_rating >= 9  and manger_id != '555' and manger_id != ''"; // select all promoter rows that's higher tahn 9
			$passive = "select * from nps where nps_rating > 6 and nps_rating < 9  and manger_id != '555' and manger_id != ''"; // select passive rows 
			$detractor = "select * from nps where nps_rating <= 6  and manger_id != '555' and manger_id != ''"; // select detractor rows  
			
			$cs_ttb = "select * from nps where sats > 3 and manger_id != '555' and manger_id != '' ";
			$cs_bb = "select * from nps where sats < 2 and manger_id != '555' and manger_id != ''";
			
			
			$fcr = "select * from nps where ir = '1' and manger_id != '555' and manger_id != ''";
			$ir = "select * from nps where  ir = '2' and manger_id != '555' and manger_id != '' ";
			...
			$ag_ttb = "select * from nps where agent_satisfaction > 3 and manger_id != '555' and manger_id != '' "; // select agent tob box 
			$ag_bb = "select * from nps where agent_satisfaction < 2 and manger_id != '555' and manger_id != '' "; // select agent bottom box 
